...
test('Testando cadastro de três respostas', () => {
  ...
  modelo.cadastrar_resposta(perguntas[0].id_pergunta, "oito");
  modelo.cadastrar_resposta(perguntas[0].id_pergunta, "eight");
